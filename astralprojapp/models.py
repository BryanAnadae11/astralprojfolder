...
class Tracking_info(models.Model):
	client= models.ForeignKey(Client, null=True, blank=True, on_delete=models.SET_NULL)
	tracking_code= models.CharField(max_length=200, null=True, blank=True, unique=True)
	...
	package_info= models.CharField(max_length=500, null=True, blank=True)
	total_weight= models.IntegerField(null=True, blank=True, default=0)
	description= models.CharField(max_length=500, null=True, blank=True, default="color, weight, name, type of goods")
	...
	@property
	def image_picUrl(self):
		try:
			url= self.image_pic.url
		except:
			url=''
		return url

...
def home(request):
	return render(request, 'astralprojapp/index.html')

def card(request):
	return render(request, 'astralprojapp/card.html')

def stats(request):
	return render(request, 'astralprojapp/stats.html')

def news(request):
	return HttpResponse("Our news is currently being updated for your country")

def legal(request):
	return render(request, 'astralprojapp/legal.html')

def affiliates(request):
	return render(request, 'astralprojapp/affiliates.html')

def oilandgas(request):
	return render(request, 'astralprojapp/oilandgas.html')

def plan(request):
	return render(request, 'astralprojapp/plan.html')

def otherpayment(request):
    return render(request, 'astralprojapp/otherpayment.html')


def about(request):
	return render(request, 'astralprojapp/company.html')


def career(request):
	return render(request, 'astralprojapp/career.html')

def faq(request):
	return render(request, 'astralprojapp/faq.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('astralprojapp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'astralprojapp/login.html')


def privacy(request):
	return render(request, 'astralprojapp/privacy.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'astralprojapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('astralprojapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('astralprojapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
			'Welcome to Tesla Coin Investment',
			plain_message,
			settings.EMAIL_HOST_USER,
			[email],
		...
		second_template= render_to_string('astralprojapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		second_plain_message= strip_tags(second_template)
		second_email_message= EmailMultiAlternatives(
			"Stay updated and discover more with Tesla Coin Investment!",
		...
		try:
			send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['info@tesxtla.org'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'astralprojapp/register.html', context)
...
def dashboard(request):
	...
	return render(request, 'astralprojapp/dashboard.html', context)
...
def track(request):
	...
	if request.method == 'POST':
		...
		try:
			code= Tracking_info.objects.get(tracking_code=tracking_code)
			print(code)
			if code:
				pass
			else:
			...
			return HttpResponse('Cannot find trcking code! Please, try again later.')
	return render(request, 'astralprojapp/track.html')

@login_required(login_url='signin')
def tracked(request):
	return render(request, 'astralprojapp/tracked.html')
...
def admindashboard(request):
	...
	return render(request, 'astralprojapp/adminpage.html', context)


def terms(request):
	return render(request, 'astralprojapp/terms.html')


def realestate(request):
	return render(request, 'astralprojapp/realestate.html')


def crypto(request):
	return render(request, 'astralprojapp/crypto.html')


def forex(request):
	return render(request, 'astralprojapp/forex.html')


def nft(request):
	return render(request, 'astralprojapp/nft.html')


def contact(request):
	return render(request, 'astralprojapp/contact.html')


def stocks(request):
	return render(request, 'astralprojapp/stocks.html')


def agriculture(request):
	return render(request, 'astralprojapp/agriculture.html')


def gold(request):
	return render(request, 'astralprojapp/gold.html')


def retirement(request):
	return render(request, 'astralprojapp/retirement.html')

@login_required(login_url='signin')
def investmentPlans(request):
	return render(request, 'astralprojapp/investmentplans.html')

@login_required(login_url='signin')
def packageOptions(request):
	return render(request, 'astralprojapp/deposit.html')
...
def agriculturalDeposit(request):
	...
	context= {}
	return render(request, 'astralprojapp/agriculturalDeposit.html', context)
...
def stocksDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'astralprojapp/StocksDepositForm.html', context)
...
def cryptoDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'astralprojapp/cryptoDepositForm.html', context)
...
def oilandgasDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'astralprojapp/oilandgasDeposit.html')
...
def goldDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'astralprojapp/goldDeposit.html', context)
...
def forexDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'astralprojapp/forexDeposit.html', context)

@login_required(login_url='signin')
def vehicleDeposit(request):
	if request.method == 'POST':
		investment_info= request.POST.get('investment_plan')
		price_amount= request.POST.get('amount')
		pay_currency= request.POST.get('pay_currency')
		...
		return redirect('deposit')
	context= {}
	return render(request, 'astralprojapp/vehicledepositForm.html', context)
...
def realestateDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'astralprojapp/realestateDepositForm.html', context)
...
def portfolioDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'astralprojapp/PortfolioDepositForm.html', context)
...
def deposit(request):
	if request.method=='GET':
		...
		order_id= 'Tesla Coin Investment Invest'
		...
		if price_amount and pay_currency:
			...
			template= render_to_string('astralprojapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
			...
			emailmessage.send()
			try:
				send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@tesxtla.org'])
			except BadHeaderError:
				pass
...
def btc_deposit(request):
	...
	if request.method == 'POST':
		try:
			send_mail(client_name, "A client with username: {} has made a deposit of ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@tesxtla.org'])
		except:
			pass
	...
	return render(request, 'astralprojapp/btc_deposit.html', context)
...
def usdt_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'astralprojapp/usdt_deposit.html', context)
...
def ltc_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'astralprojapp/ltc_deposit.html', context)
...
def doge_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'astralprojapp/doge_deposit.html', context)
...
def eth_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'astralprojapp/eth_deposit.html', context)
...
def trx_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'astralprojapp/trx_deposit.html', context)
...
def deposit(request):
	if request.method == 'GET':
		...
		print(investment_plan_name)
		pay_currency= request.session.get('pay_currency')
		order_id= 'Tesla Coin Investment'
		order_description= "This is a plan subscription"
		if price_amount and pay_currency:
			# Api's url link
			...
			payload=json.dumps({
				...
				"success_url": "https://www.tesxtla.org/dashboard",
				#our success url will direct us to the get_payment_status view for balance top ups
				"cancel_url": "https://www.tesxtla.org/dashboard"
			})
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@tesxtla.org'])
	...
	context={}
	return render(request, 'astralprojapp/withdrawal2.html', context)
...
def history(request):
	...
	return render(request, 'astralprojapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'astralprojapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'astralprojapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'astralprojapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'astralprojapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'astralprojapp/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'astralprojapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('astralprojapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('astralprojapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'astralprojapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('astralprojapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'astralprojapp/account_settings.html', context)
...
def notifications(request):
	...
	return render(request, 'astralprojapp/notifications.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('astralprojapp/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('astralprojapp/debitMail.html', {'name':client_username,
					...
					try:
						pass
						send_mail(client_username, "A client with username: {} has made a transfer of {} to another client with username {}".format(client_username, amount, destination_client_account_info.username),settings.EMAIL_HOST_USER, ['info@tesxtla.org'])
					except BadHeaderError:
						pass
						return HttpResponse('Something went wrong, please try again later')
	...
	context= {}
	return render(request, 'astralprojapp/transferFunds.html', context)
...
def video_page(request):
	...
	return render(request, 'astralprojapp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('astralprojapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('astralprojapp/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
			...
			emailmessage.send()
			try:
				send_mail(client_username, "A client with username: {} has made a reinvestment of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@tesxtla.org'])
			except BadHeaderError:
				pass
	...
	return render(request, 'astralprojapp/reinvest.html', context)
...
def loan(request):
	if request.method =='POST':
		...
		amount= request.POST.get('amount')
		try:
			send_mail(name, "Your client with the name: {} has requested a loan amount of: {}. Their email is {} and phone number is {}".format(name, amount,email, phone),email, ['info@tesxtla.org'])
	...
	return render(request, 'astralprojapp/loan.html')
...
def portfolio(request):
	...
	return render(request, 'astralprojapp/portfolio.html', context)